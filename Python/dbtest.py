...
"Alliance Ouchi-Odonovan 6-12 Complex", 
...
"Coeur Dalene Avenue Elementary", 
...
"Mid-Citys Prescott School Of Enriched Sciences", 
"Middle College High", 
...
def addSchool( conn, schoolToAdd ) :
    cur = conn.cursor()
    cur.execute( "INSERT INTO Schools (schoolname) VALUES ('"+ schoolToAdd + "');" )


myConnection = mysql.connector.connect( host=hostname, user=username, passwd=password, db=database )

for i in range(0,len(schools)):
	addSchool( myConnection, schools[i] )
