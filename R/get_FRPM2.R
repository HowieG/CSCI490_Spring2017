...
get_FRPM <- function(schoolyear) {
  ...
  names(FRPM_Data_Complete)[columns_to_keep[2]] <- "total_enrollment"
  names(FRPM_Data_Complete)[columns_to_keep[3]] <- "free_meal_eligible"
  names(FRPM_Data_Complete)[columns_to_keep[4]] <- "free_meal_eligible_percent"
  names(FRPM_Data_Complete)[columns_to_keep[5]] <- "FRPM_eligible"
  names(FRPM_Data_Complete)[columns_to_keep[6]] <- "FRPM_eligible_percent"
  
  FRPM_Data_Complete <- FRPM_Data_Complete[columns_to_keep]
  
  View(FRPM_Data_Complete)
  
  return(FRPM_Data_Complete)
}
